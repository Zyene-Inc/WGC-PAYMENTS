  ...
  return (
    <>
      ...
      <main className="flex-grow bg-white">
        ...
        <section className="py-20 text-wgc-navy-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-headings:text-wgc-navy-950 prose-a:text-wgc-gold-600">
            <ScrollFade>
              ...
              <p>
                Upgrading your payment infrastructure is a significant step, but it doesn't have to be disruptive. Experience our donor-centric interface by trying out our <Link href="/demo/donation">live donation page demo</Link>. Take the next step toward better stewardship and <Link href="/register">register your church or software platform</Link> with WGC today.
              </p>
            </ScrollFade>
          </div>
        </section>
        ...
        <CTASection 
          title="Looking for a better giving platform?"
          description="Switch to WGC and keep more of every dollar for your Kansas City ministry."
        />
      </main>
      <Footer />
    </>
