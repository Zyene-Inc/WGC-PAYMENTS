        ...
        <section className="py-20 text-wgc-navy-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-headings:text-wgc-navy-950 prose-a:text-wgc-gold-600">
            <ScrollFade>
              ...
              <p>
                Transitioning your church's payment processing shouldn't be a headache. We provide dedicated onboarding and a frictionless experience for your donors. Take a look at our <Link href="/demo/donation">interactive donation page demo</Link> to see the exact flow your KC congregation will experience when giving. Ready to get started? <Link href="/register">Register your organization today</Link>.
              </p>
            </ScrollFade>
          </div>
        </section>
