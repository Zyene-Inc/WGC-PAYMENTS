  ...
  return (
    <>
      ...
      <main className="flex-grow bg-white">
        ...
        <section className="py-20 text-wgc-navy-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg prose-headings:text-wgc-navy-950 prose-a:text-wgc-gold-600">
            <ScrollFade>
              ...
              <p>
                We make it easy for donors to give. Our platform supports highly customized, secure giving portals. See how it looks by exploring our <Link href="/demo/donation">donation page demo</Link>. If your Kansas City nonprofit or software platform is ready to upgrade its payment rails, <Link href="/register">register today to get started</Link>.
              </p>
            </ScrollFade>
          </div>
        </section>
        ...
        <CTASection 
          title="Ready to maximize your nonprofit's impact?"
          description="Join other Kansas City organizations leveraging WGC's transparent payment infrastructure."
        />
      </main>
      <Footer />
    </>
